...
$query=mysql_query("insert into tblcomplaints(userId,category,complaintDetails,complaintFile) values('$uid','$category','$complaintdetials','$compfile')");
...
<label class="col-sm-2 col-sm-2 control-label">Item Category</label>
<div class="col-sm-4">
